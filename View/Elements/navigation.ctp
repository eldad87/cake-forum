...
<div class="navigation">
	...
	if ($user) { ?>
		...
		<div>
			<?php echo sprintf(__d('forum', 'Welcome %s'), $this->Html->link($user['User'][$config['userMap']['username']], array('controller' => 'users', 'action' => 'profile', $user['User']['user_id'], 'admin' => false))); ?>
		</div>
